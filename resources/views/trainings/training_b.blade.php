...
<div class="service-details ptb-100">
    ...
    <div class="service-details-content">
        ...
        <h4>Free Setup: </h4>
        <p>Get free Excel software installation</p>

        <h4>Introduction to EXCEL SPREADSHEET</h4>
        
        <p>Concepts of a spreadsheet, Data entry, Importing, sorting and coding</p>
        <p>
        <img style="float: right;width:650px;" src="{{ asset('assets/img/marketing-agency/services-img9.jpg') }}" alt="image">
            <ul>
        ...
        <p>Intermediate Excel Shortcuts</p>
        <ul>
            <li>Extensive exercise on excel shortcuts</li>
            <li>Doing away with the mouse</li>
            <li>Mastering the shortcut window</li>
        </ul>
        <p>Filter and sort Excel data.</p>
        <p>Create formulas by using some of Excel's built-in functions. </p>
        <ul>
            <ul>
                <li> Upper, Lower, Proper and TRM</li>
                <li> Left, Mid, And Right</li>
                <li> CONCATENATE & (Ampersand)</li> 
                <li> CONCATENATE Vs. & (Ampersand)</li>
                <li> Roundup, And ROUNDDOWN</li> 
                <li> VLOOKUP And HLOOKUP</li>
                <li> IF</li>
                <li> Nested IF</li> 
                <li> If and AND</li>
                <li> SUMIF </li>
                <li> Error Values in Excel...</li>
                <li> Rand and Rand between</li>
            </ul>
        </ul>
        ...
        <ul>
            ...
            <li> Chart Layout Options</li>
            <li> Multiple Series within a chart</li> 
            <li> Modifying Gridlines</li>
        </ul>
        <p>Filters</p>
        <p>Text to Columns (Data Parsing) - UPPER, LOWER, PROPER AND TRIM</p>

        <h4>Advanced EXCEL</h4>

        <p>Understanding References</p>
        <ul>
            <li> Relative, Absolute & Mixed reference </li>
            <li> Referencing different workbooks & Merging </li>
            <li> Consolidating data, linking cells in different work books </li>
            <li> Utilizing Dynamic Named Ranges for writing formulas and functions</li>
        </ul>
        <p>Data Analysis Report Pivot Tables & Pivot Charts</p>
        <ul>
            <li> Analyzing and generating reports of large data using PivotTables.</li> 
            <li> Creating PivotTables, editing and updating changes in PivotTable.</li> 
            <li> Using Slicers in Pivot Table </li>
            <li> Creating Pivot Chart</li>
        </ul>
        <p> Data Validations and Protection</p>
        <p> Financial Analysis and Formulas</p>
        <ul>
            <li> Using IRR </li>
            <li> Using NPV</li>
        </ul>
        <p>Budgeting under Scenarios</p>
        <p>Excel Macros and VBA for Programming</p>
        <ul>
            <li> Introduction to Excel Macros </li>
            <li> Recording and Running a Macro </li>
            <li> Absolute vs Relative</li> 
            <li> Assigning Buttons to Macros</li> 
            <li> Assigning Macros to an Auto Shape and to an icon on a Tool bar</li>
            <li> Sheet Controls and User Form Controls</li> 
...
@section('scripts')
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title text-center" id="exampleModalLongTitle">Become an Excel expert in 7 days.</h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <select name="hour" class="form-control">
                        ...
                        <option selected value="Excel Training">Excel Training</option>

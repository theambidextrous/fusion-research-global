...
<div class="service-details ptb-100">
    ...
    <div class="service-details-content">
        ...
        <div class="service-details-info">
            ...
            <div class="single-info-box">
                <h4>Plagiarism Works  <br> Done</h4>
                <span>400+</span>
            </div>
            <div class="single-info-box">
...
@section('scripts')
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title text-center" id="exampleModalLongTitle">Want help with Plagiarism? Get it done in 2days.</h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <select name="hour" class="form-control">
                        ...
                        <option selected value="Plagiarism Management">Plagiarism Management</option>
                    </select>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12">
